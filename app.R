        ...
        navbarPage(
           ...
           tabPanel(title = "About", 
                    ...
                    tags$ul(
                      ...
                      tags$li(strong("Paper :"), "Ramya Roopa, S. & Kelkar, N. (2024). FLOWIDER 1.0: a web-based interface to track flood-season water levels of large rivers of India’s Gangetic plains.")
                    ),
